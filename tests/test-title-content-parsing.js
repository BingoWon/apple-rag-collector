...
function testTitleContentParsing() {
  ...
  try {
    ...
    const embeddingText = parsed.title ? `${parsed.title}\n\n${parsed.content}` : parsed.content;
  ...
  "content": "Some content without title"
    ...
    const embeddingTextNoTitle = parsedNoTitle.title ? `${parsedNoTitle.title}\n\n${parsedNoTitle.content}` : parsedNoTitle.content;
    console.log('  - Result:', embeddingTextNoTitle);
    console.log('  - Title fallback works:', embeddingTextNoTitle === parsedNoTitle.content ? 'Yes' : 'No');
    console.log('');
