...
// Test URL
const TEST_URL = 'https://developer.apple.com/documentation/matter/mtrbaseclusterelectricalmeasurement/readattributermscurrentphasec(completionhandler:)';
...
class ValidationError extends Error {
  constructor(field, value, expected) {
    super(`Validation failed for ${field}: expected ${expected}, got ${typeof value}`);
...
async function main() {
  ...
  if (results.success) {
    ...
    console.log(`Content Length: ${results.data.processedContent.content.length} characters`);
    console.log(`Extracted URLs: ${results.data.processedContent.extractedUrls.length}`);
